...
function am_custom_script_post() {
    ...
    if ($post->post_type === 'am_event' && is_admin()) {
		...
		// include JQuery
        wp_enqueue_script(
                'jquery-custom', plugins_url('/script/jquery-ui.min.js', __FILE__)
        );
        ...
        wp_register_script('jquery-ui-timepicker', plugins_url('/script/jquery-ui-timepicker-addon-min.js', __FILE__));
        wp_localize_script('jquery-ui-timepicker', 'localization', $localization); //pass any values to javascript
        wp_enqueue_script(
                'jquery-ui-timepicker', plugins_url('/script/jquery-ui-timepicker-addon-min.js', __FILE__), array('jquery-custom')
        );
...
function am_custom_css() {
    ...
    wp_enqueue_style(
            'jquery.ui.theme', plugins_url('/css/jquery-ui.min.css', __FILE__));
    wp_enqueue_style(
            'jquery.ui.timepicker', plugins_url('/css/jquery-ui-timepicker-addon-min.css', __FILE__));		
    wp_enqueue_style(
            'jquery.ui.timepicker', plugins_url('/css/jquery-ui.structure.min.css', __FILE__));
	wp_enqueue_style(
            'jquery.ui.timepicker', plugins_url('/css/jquery-ui.theme.min.css', __FILE__));
